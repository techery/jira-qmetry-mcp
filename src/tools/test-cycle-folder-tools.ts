...
export const testCycleFolderTools: Array<ToolDefinition> = [
    {
        ...
        handler: async ({ projectId, sort, withCount }: GetTestCycleFoldersParams) => {
    ...
    },
    {
        ...
        handler: async ({ folderName, projectId, parentId, description }: CreateTestCycleFolderParams) => {
    ...
    },
    {
        ...
        handler: async ({ folderName, description, projectId, folderId }: EditTestCycleFolderParams) => {
    ...
    },
    {
        ...
        handler: async ({ projectId, folderId, newParentId }: MoveTestCycleFolderParams) => {
    ...
    },
    {
        ...
        handler: async ({ projectId, folderName, mode }: SearchTestCycleFoldersParams) => {
